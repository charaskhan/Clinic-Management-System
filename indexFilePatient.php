    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="https://www.tutorialswb.com">Medical Records</a>
            </div>
        </div>
    </nav>
    <br />
...
<!--    </form>-->
    ...
    <div class="form-group">
        ...
        <table id="example" class="display responsive nowrap" style="width:100%">
            ...
            $row = $conn->query("SELECT * FROM file where patient_id='$id' ") or die(mysqli_error());
            while($fetch = $row->fetch_array()){
                ...
                <tr>
                    ...
                    <td><a href="forDownload.php?file=<?php echo $name[1]?>" class="btn btn-primary"><span class="glyphicon glyphicon-download"></span> Download</a></td>
