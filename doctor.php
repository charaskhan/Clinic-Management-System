...
<table width="1350" height="640" border="1" >
    <tr> <td colspan="2" style="background-color:#102445;"> <h1 style="color: #e6e6e6">CLINIC MANAGEMENT SYSTEM</h1>
            ...
            <h3 style="color: #e6e6e6 " align="center">DOCTOR PANEL</h3>
        </td>
    </tr>
    <tr>
        <td style="background-color:#01A1DB;width:50px;height:400px;">
            <table align="center" height="100px" weight="50px">
                <tr>
                    <td>
                        <form action="Calendar.html" align="center"> <input type="submit" align="center" value="Enter an Appointment"> </form>
                    </td>
                </tr>
                <tr>
                    <td>
                        <form action="loginChat.php" align="center">
                            <input type="submit" align="center" value=" Chat with patient ">
                        </form>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <form action="patientListforDoc.php" align="center">
                            <input type="submit" align="center" value="See list of patients">
                        </form>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <form action="deleteRow.php" align="center">
        ...
        <td><table>
                ...
                <div class="container" style="width:800px;">
                    ...
                    <h3 align="center">Doctor Data</h3>
                    <br /><br />
